...
All Fink codes are open source hosted in [GitHub :lucide-github:](https://github.com/astrolabsoftware){target="_blank"} and under Apache 2.0 license.

## Fink ecosystem

A non-exhaustive list of external modules and tools extending the Fink codebase:
