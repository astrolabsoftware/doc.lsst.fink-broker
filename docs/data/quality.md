...
This field is provided by the Rubin team, and sent to us ([learn more :lucide-external-link:](https://prompt-products.lsst.io/processing/filtering/index.html) about it).
...
!!! warning "`reliability` score is not reliable yet"
    Do not use `reliability` score blindly as the survey starts. It will get updated frequently to account for what the Rubin project and the broker learn.
